...
DIALOG IDC_EXTRACT_ZIP_FILE
{
  ...
  GROUP IDC_STATIC
  {
    NAME IDS_STATIC10; SCALE_V; SCALE_H; 
    BORDERSTYLE BORDER_NONE; BORDERSIZE 6, 6, 6, 6; 
    COLUMNS 1;
    ...
    GROUP IDC_STATIC
    {
      ...
      BUTTON IDC_EXTRACT_CHANGE_FILE_BTN { NAME IDS_EXTRACT_CHANGE; CENTER_V; ALIGN_LEFT; }
    }
    TREEVIEW IDC_EXTRACT_FILES_TREE
    {
      SCALE_V; SCALE_H; SIZE 500, 100; 
      BORDER; 
      HIDE_LINES; 
      HAS_HEADER; 
      RESIZE_HEADER; 
